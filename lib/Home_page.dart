import 'package:blinkit_clone_app/my_account.dart';
import 'package:blinkit_clone_app/widgets/categories_widget.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  // Using ValueNotifier to track dot position
  ValueNotifier<int> _dotPositionNotifier = ValueNotifier<int>(0);

  // Fetch carousel images from Firebase Firestore
  fetchCarouselImages() async {
    var _firestoreInstance = FirebaseFirestore.instance;
    QuerySnapshot qn =
        await _firestoreInstance.collection("carousel-images").get();
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              children: [
                ...
                AspectRatio(
                  ...
                  child: CarouselSlider(
                      ...
                      options: CarouselOptions(
                          ...
                          enlargeFactor: 0.3,
                          onPageChanged: (val, carouselPageChangedReason) {
                            // Update dot position using ValueNotifier
                            _dotPositionNotifier.value = val;
                          })),
                ),
                const SizedBox(height: 10),
                // Use ValueListenableBuilder to rebuild the dots indicator
                ValueListenableBuilder<int>(
                  ...
                  builder: (context, dotPosition, child) {
                    return DotsIndicator(
                      ...
                      position:
                          dotPosition.toInt(), // Safely using the updated value
                      decorator: const DotsDecorator(
                        activeColor: Colors.black,
                        color: Colors.blueGrey,
                        spacing: EdgeInsets.all(2),
                ...
                const SizedBox(height: 10),
                // The CategoriesScreen widget remains scrollable inside SingleChildScrollView
                CategoriesScreen(),
              ],
            ),
          ),
